module.exports = 
{
  ...
  translateGreetings: false, // if true, the bot will attempt to translate the tweet into the language most common in the country where the picture was taken (using Yandex.translate)
